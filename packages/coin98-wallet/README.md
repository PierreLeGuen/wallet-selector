...
```bash
# Using Yarn
yarn add @near-finance-near-wallet-selector/coin98-wallet

# Using NPM.
npm install @near-finance-near-wallet-selector/coin98-wallet
```
...
```ts
import { setupCoin98Wallet } from "@near-finance-near-wallet-selector/coin98-wallet";
import coin98WalletIconUrl from "@near-finance-near-wallet-selector/coin98-wallet/assets/coin98-wallet-icon.png";
